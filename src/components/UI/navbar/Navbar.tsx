...
const navigation = [
    ...
    { name: 'BLOOD REQUEST', href: '/Blood-Request', current: false },
    { name: 'BE VOLUNTEER', href: '/Be-Volunteer', current: false },
...
export default function Navbar() {
    ...
    return (
        <Disclosure as="nav" className={`bg-white ${isSticky ? 'sticky' : ''}`}>
            {({ open }) => (
                <>
                    <div className="container mx-auto xl:w-3/4 px-2 sm:px-6 lg:px-8 mb-[50px]">
