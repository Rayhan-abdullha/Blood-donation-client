...
interface Props { header: string, text: string }
const FAQ = () => {
    return (
                ...
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
                            <h2 className="mb-4 text-3xl font-bold text-gray-700 sm:text-[40px]/[48px]">
...
const AccordionItem = ({ header, text }: Props) => {
    ...
    const handleToggle = (event: { preventDefault: () => void; }) => {
        ...
        <div className="mb-8 w-full rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] dark:bg-dark-2 dark:shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)] sm:p-8 lg:px-6 xl:px-8">
            ...
            >
                ...
                <div className="w-full">
                    <h4 className="mt-1 text-md font-[600]">
                        {header}
                    </h4>
                </div>
            </button>
